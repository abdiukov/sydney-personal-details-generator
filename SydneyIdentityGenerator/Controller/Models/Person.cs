...
public abstract class Person
{
    ...
    public virtual void BuildAddress() => Address = Helper.AddressGenerator.GetRandomAddress();
    ...
    public virtual void BuildDateOfBirth() => DateOfBirth = $"{1920 + Random.Shared.Next(0, 85)}-{Random.Shared.Next(1, 13)}-{Random.Shared.Next(1, 29)}";
